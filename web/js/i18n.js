...
const de = {
  ...
  help_shortcuts: [
    ...
    ['N / H', 'Kupplungs-Namen / Hinweise ein/aus'],
    ['C', 'Ansicht zurücksetzen'],
    ['Strg/Cmd + Z', 'Rückgängig'],
    ['Strg/Cmd + Shift + Z', 'Wiederholen'],
    ['Strg/Cmd + N / Alt + N', 'neues Modell (Strg+N fängt der Browser oft ab)'],
    ...
    ['Strg/Cmd + E', 'als QDF exportieren'],
...
const en = {
  ...
  help_shortcuts: [
    ...
    ['B / S', 'Build / Select'],
    ['P / R / F', 'Panel / Slide / Accessory'],
    ['K / V', 'Double tube / Reinforce'],
    ['A', 'Assembly mode (layer by layer)'],
    ['D', 'Toggle diagonal brace (45°)'],
    ['N / H', 'Toggle connector labels / hints'],
    ['C', 'Reset camera'],
    ['Ctrl/Cmd + Z', 'Undo'],
    ['Ctrl/Cmd + Shift + Z', 'Redo'],
    ['Ctrl/Cmd + N / Alt + N', 'New model (Ctrl+N is often taken by the browser)'],
    ['Ctrl/Cmd + S', 'Save'],
    ['Ctrl/Cmd + Shift + S', 'Save as…'],
    ['Ctrl/Cmd + O', 'Open my models'],
    ['Ctrl/Cmd + 1 … 9', 'Jump to the n-th design, 9 = last'],
    ['Ctrl/Cmd + E', 'Export as QDF'],
