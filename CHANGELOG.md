...
### Behoben · Fixed
- Rutschen wurden als starres Teil fester Länge behandelt (128 cm bei 38,7°) und landeten dadurch neben dem Boden. Fest ist nur die Neigung (35,4°); Fall und Auslauf ergeben sich aus der Einhänghöhe, der Fuß liegt auf dem Boden. Gemessen an 43 Rutschen der Herstellerdateien: Fall 45 cm → Auslauf 63,2 cm, Fall 85 cm → 120 cm · Slides were treated as a rigid part of fixed length (128 cm at 38.7°) and so ended up beside the ground. Only the slope is fixed (35.4°); drop and run follow from the mounting height and the foot rests on the ground
