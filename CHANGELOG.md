...
- **Statusmeldungen bleiben stehen**, bis die nächste kommt (vorher nach 2,5 s weg) · **Status messages stay** until the next one arrives (they used to vanish after 2.5 s)

### Hinzugefügt · Added
- **Anbauteile setzen** – neuer Modus mit eigenem Knopf und Klappliste: Rad, Laufrad, Nabenkappe, Lenkrolle, Lenkarretierung, Radadapter, Lagerkupplung, Lochzapfenkupplung, offener Anschluss, Spielsack, Gitter, Rundabdeckung und großes Dach. Wo die Ankerpunkte auftauchen, richtet sich nach dem Teil: an einer Kupplung jede freie Achsrichtung, auf einem Rohr im gemessenen Abstand vom Rohrende, das Gitter über zwei parallele Rohre wie eine Platte, die Rundabdeckung über zwei Bogenrohre im 80-cm-Abstand, das große Dach als Giebel auf einem waagerechten Rohr. Klick auf ein gesetztes Teil nimmt es wieder weg · **Place accessories** – new mode with its own button and drop-down list: wheel, floating wheel, hub cap, caster, steering lock, wheel adapter, bearing connector, hole connector, open connector, play bag, lattice, round cover and large roof. Where the anchor points appear depends on the part; clicking a placed part removes it again
